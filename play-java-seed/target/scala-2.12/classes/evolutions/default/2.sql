...
insert into product (id,category_id,name,description,stock,price) values ( 7,6,'Washi ng Machine','1600rpm spin,A+++ rated,10KG',50,699.00 );
...
insert into product (id,category_id,name,description,stock,price) values ( 11,4,'Bed','SuperKing size,super comfort mattress',5,899.00 );
